      ...
      <div class="col-md-12">
        <div class="col-sm-4">
          <div class="row">
            <div class="col-sm-8">
              <div class="thumbnail">
                <img src="{{ asset('/devloper/1.jpg') }}" alt="No Image" width="100% "class="img-responsive">
                <div class="caption">
                  <h4>
                    <b>TARIF HOSSAIN</b>
                  </h4>
        ...
        <div class="col-sm-4">
          <div class="row">
            <div class="col-sm-8">
              <div class="thumbnail">
                <img src="{{ asset('/devloper/3.jpg') }}" alt="No Image" class="img-responsive" width="100% ">
                <div class="caption">
                  <h4>
                    <b>FAHAD IBNE MOSTAFA</b>
                  </h4>
                  <br>
      ...
      <div class="col-md-12">
        <div class="col-sm-6" style="padding-left: 200px;">
          <div class="row">
            <div class="col-sm-7">
              <div class="thumbnail">
                <img src="{{ asset('/devloper/4.jpg') }}" alt="No Image" class="img-responsive" width="100% ">
                <div class="caption">
                  <h4>
                    <b>IMRUL QUAYES HIMEL</b>
                  </h4>
                  <br>
        ...
        <div class="col-sm-5" style="padding-left: 140px;">
          <div class="row">
            <div class="col-sm-8">
              <div class="thumbnail">
                <img src="{{ asset('/devloper/5.jpg') }}" alt="No Image" class="img-responsive" width="100% ">
                <div class="caption">
                  <h4>
                    <b>SOYKOT PAROI</b>
                  </h4>
