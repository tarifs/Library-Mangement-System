                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('users.update', $user->id)); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <?php else: ?>
                                <p>Old Image</p>
                                <img width="100px" class="img-rounded" src="<?php echo e(asset('storage/avatar/'. $user->avatar)); ?>" />
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <?php else: ?>
                                <p>Old Image</p>
                                <img width="100px" class="img-rounded" src="<?php echo e(asset('storage/identity/'. $user->identity)); ?>" />
                                <span class="help-block">
                                    Only image supported
                                </span>
                            <?php endif; ?>
