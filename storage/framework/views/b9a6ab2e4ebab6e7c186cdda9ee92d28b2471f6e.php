        ...
        <div class="page-sidebar">
            ...
            <ul class="x-navigation">
                ...
                <?php if(Auth::user()->is_admin): ?>
                    ...
                    <li class="xn-openable">
                        <a href=""><span class="fa fa-rss-square"></span> <span class="xn-text">Repositories</span></a>
                        <ul>
                            <li>
                                <a href="<?php echo e(route('ebook.index')); ?>"><span class="fa fa-list-alt"></span> <span class="xn-text">Ebook</span></a>
                            </li>
                        </ul>
                <?php endif; ?>
