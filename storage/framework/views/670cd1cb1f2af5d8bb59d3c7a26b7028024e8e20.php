    ...
    <div class="page-container">
        ...
        <div class="page-sidebar">
            ...
            <ul class="x-navigation">
                <li class="xn-logo">
                    <a href="<?php echo e(route('blog')); ?>">LMS</a>
                    <a href="/" class="x-navigation-control"></a>
                </li>
                <li class="xn-profile">
                    <a href="" class="profile-mini">
                        <img src="<?php echo e(asset('uploads/avatar/'. Auth::user()->avatar)); ?>" alt="Lol"/>
                    </a>
                    <div class="profile">
                ...
                <?php if(!Auth::user()->is_admin): ?>
                    <li >
                        <a href="<?php echo e(route('user.bookList')); ?>"><span class="fa fa-book"></span> <span class="xn-text">Book List</span></a>
                    </li>
                    <li >
                    ...
                    <li >
                        <a href="<?php echo e(route('changPass')); ?>"><span class="fa fa-key"></span> <span class="xn-text">Change Password</span></a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(Auth::user()->is_admin): ?>
                    ...
                    <li >
                        <a href="<?php echo e(route('category.index')); ?>"><span class="fa fa-tasks"></span> <span class="xn-text">Department</span></a>
                    </li>
                    <li >
                        <a href="<?php echo e(route('sub-category.index')); ?>"><span class="fa fa-tasks"></span> <span class="xn-text">Subject-wise List</span></a>
                    </li>
                    <li >
                    ...
                    <li class="xn-openable">
                        ...
                        <ul>
                            <li>
                                <a href="<?php echo e(route('policy.edit')); ?>"><span class="fa fa-bullhorn"></span> <span class="xn-text">Library Policy</span></a>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <a href="<?php echo e(route('staffs.index')); ?>"><span class="fa fa-user"></span> <span class="xn-text">Staff</span></a>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <a href="<?php echo e(route('contact.index')); ?>"><span class="fa fa-phone-square"></span> <span class="xn-text">Contact</span></a>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <a href="<?php echo e(route('about.edit')); ?>"><span class="fa fa-calendar"></span> <span class="xn-text">About</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="xn-openable">
                        ...
                        <ul>
                            <li>
                                <a href="<?php echo e(route('recent.index')); ?>"><span class="fa fa-tags"></span> <span class="xn-text">Recent Addition</span></a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('ebook.index')); ?>"><span class="fa fa-book"></span> <span class="xn-text">Ebook</span></a>
                            </li>
                        </ul>
                <?php endif; ?>
