        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="pull-right">
                    <div class="col-sm-12">
                        <br>
                        <a href="<?php echo e(route('category.create')); ?>" class="btn btn-primary">Add Department</a>
                    </div>
                </div>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <form class="" action="<?php echo e(route('category.destroy',  $category->id)); ?>" method="post">
                                        ...
                                        <a class="btn btn-xs btn-dark" href="<?php echo e(route('category.edit',  $category->id)); ?>">Edit</a>
