                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('users.show', $user->id)); ?>" class="btn btn-xs btn-success">Profile</a>

                                    <?php if($user->id == Auth::user()->id): ?>
                                    <a href="<?php echo e(route('changPass')); ?>" class="btn btn-xs btn-info">Change Password</a>
                                    <?php endif; ?>
