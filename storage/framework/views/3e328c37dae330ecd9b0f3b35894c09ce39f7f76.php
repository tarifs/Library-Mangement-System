                            ...
                            <?php if($books): ?>
                                <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($book->sub_category ? $book->sub_category->name : ''); ?></td>
                                        ...
                                        <td>
                                            <a style="width: 50px" class="btn btn-xs btn-dark" href="<?php echo e(route('books.edit', $book->id)); ?>">Edit</a>

                                            <a style="width: 50px" class="btn btn-xs btn-success" href="<?php echo e(route('books.show', $book->id)); ?>">Details</a>
