                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <form class="" action="<?php echo e(route('notices.destroy',  $notice->id)); ?>" method="post">
                                        ...
                                        <a class="btn btn-xs btn-dark" href="<?php echo e(route('notices.edit',  $notice->id)); ?>">Edit</a>
                                        <a class="btn btn-xs btn-success"   href="<?php echo e(route('notices.show',$notice->id)); ?>">Details</a>
