                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-8">
                            ...
                            <div style="padding-top:  30px;" class="form-group<?php echo e($errors->has('sub_category_id') ? ' has-error' : ''); ?>">
                                <label for="categories" class="col-md-4 control-label">Subject</label>
                                <div class="col-md-6">
                                    <?php echo e($book->sub_category? $book->sub_category->name : ''); ?> 
                                </div>
                            </div>
                            ...
                            <div style="padding-top:  30px;" class="form-group<?php echo e($errors->has('accession_no') ? ' has-error' : ''); ?>">
                                <label for="accession_no" class="col-md-4 control-label">Accession No</label>

                                <div class="col-md-6">
                                    <?php echo e($book->accession_no); ?>

                                </div>
                            </div>
                            <div style="padding-top:  30px;" class="form-group<?php echo e($errors->has('doa') ? ' has-error' : ''); ?>">
                            ...
                            <div style="padding-top:  30px;" class="form-group<?php echo e($errors->has('call_no') ? ' has-error' : ''); ?>">
                                <label for="call_no" class="col-md-4 control-label">Call No</label>

                                <div class="col-md-6">
                                    <?php echo e($book->call_no); ?>
