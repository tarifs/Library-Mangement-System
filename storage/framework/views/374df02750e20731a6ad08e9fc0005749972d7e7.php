        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('staffs.store')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group<?php echo e($errors->has('degree') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="degree" type="text" class="form-control" name="degree" value="<?php echo e(old('degree')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('rank') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="rank" type="text" class="form-control" name="rank" value="<?php echo e(old('rank')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('cell') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="cell" type="text" class="form-control" name="cell" value="+880<?php echo e(old('cell')); ?>" required autofocus>
