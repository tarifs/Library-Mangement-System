                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo e(route('books.store')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group<?php echo e($errors->has('page') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="page" type="text" class="form-control" name="page" value="<?php echo e(old('page')); ?>" >
                        ...
                        <div class="form-group<?php echo e($errors->has('file') ? ' has-error' : ''); ?>">
                            <label for="file" class="col-md-4 control-label">Book file</label>

                            <div class="col-md-6">
                                <input id="file" type="file" class="form-control" name="file" value="<?php echo e(old('file')); ?>" autofocus>
