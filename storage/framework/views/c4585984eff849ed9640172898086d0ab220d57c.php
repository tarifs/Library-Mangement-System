	...
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			<div class="navbar-header navbar-left">
				...
				<h1><a class="navbar-brand" href="<?php echo e(route('blog')); ?>"><i>GB</i><span>Library</span></a></h1>
			</div>
			<!-- Collect the nav links, forms, and other content for toggling -->
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<nav class="menu--iris">
					<ul class="nav navbar-nav menu__list" style="padding-left: 200px">
						<li class="menu__item "><a href="<?php echo e(route('blog')); ?>" class="menu__link">Home</a></li>
						<li class="menu__item"><a href="<?php echo e(route('policy')); ?>" class="menu__link">Lib. Policy</a></li>
						<li class="menu__item"><a href="<?php echo e(route('staffs')); ?>" class="menu__link">Staff</a></li>

						<li class="dropdown menu__item">
							<a href="#" class="dropdown-toggle menu__link dropbtn" data-toggle="dropdown">Repositories <b class="caret"></b></a>
							<ul class="dropdown-menu agile_short_dropdown">
								
								<li><a href="<?php echo e(route('ebooks')); ?>">e-Books</a></li>
								
							</ul>
						</li>
						<li class="menu__item"><a href="<?php echo e(route('contact')); ?>" class="menu__link">Contact</a></li>
						<li class="menu__item"><a href="<?php echo e(route('about')); ?>" class="menu__link">About Us</a></li>
						...
						<li class="menu__item"><a href="<?php echo e(route('home')); ?>" class="menu__link">Dashboard</a></li>
			...
			<div class="modal-header">
				...
				<div class="signin-form profile">
					...
					<div class="login-form">
						<form class="form-horizontal" method="POST" action="<?php echo e(route('login')); ?>" onsubmit="return Validate()">
							<?php echo e(csrf_field()); ?>
...
<div class="footer">
	<div class="f-bg-w3l">
		...
		<div class="col-md-12 w3layouts_footer_grid text-center">
			<p>© <?php echo date("Y"); ?> GONO LIBRARY. All Rights Reserved | Developed by <a href="<?php echo e(route('developers')); ?>" class="blink_me" style="color:yellow" target="_blank" >CSE 19th Batch</a></p>
		</div>
	</div>
