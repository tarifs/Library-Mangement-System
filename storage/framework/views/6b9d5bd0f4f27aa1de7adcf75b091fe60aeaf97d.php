        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo e(route('books.store')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group<?php echo e($errors->has('edition') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="edition" type="text" class="form-control" name="edition" value="<?php echo e(old('edition')); ?>" >
                        ...
                        <div class="form-group<?php echo e($errors->has('page') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="page" type="number" class="form-control" name="page" value="<?php echo e(old('page')); ?>" >
                        ...
                        <div class="form-group<?php echo e($errors->has('publisher') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="publisher" type="text" class="form-control" name="publisher" value="<?php echo e(old('publisher')); ?>" >
                        ...
                        <div class="form-group<?php echo e($errors->has('language') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="language" type="text" class="form-control" name="language" value="<?php echo e(old('language')); ?>" >
                        ...
                        <div class="form-group<?php echo e($errors->has('isbn') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="isbn" value="<?php echo e(old('isbn')); ?>" >
                        ...
                        <div class="form-group<?php echo e($errors->has('purchase_date') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="purchase_date" type="date" class="form-control" name="purchase_date" value="<?php echo e(old('purchase_date')); ?>" >
                        ...
                        <div class="form-group<?php echo e($errors->has('accession_no') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="accession_no" type="number" class="form-control" name="accession_no" value="<?php echo e(old('accession_no')); ?>" >
                        ...
                        <div class="form-group<?php echo e($errors->has('doa') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="doa" type="date" class="form-control" name="doa" value="<?php echo e(old('doa')); ?>" >
                        ...
                        <div class="form-group<?php echo e($errors->has('quantity') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="quantity" type="number" class="form-control" name="quantity" value="<?php echo e(old('quantity')); ?>" >
                        ...
                        <div class="form-group<?php echo e($errors->has('call_no') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="call_no" type="text" class="form-control" name="call_no" value="<?php echo e(old('call_no')); ?>" >
